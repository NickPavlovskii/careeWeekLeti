...
.dots {
  ...
  width: 260px;
  height: 150px;
  background-image: radial-gradient(#c9d2db 2px, transparent 2px);
...
.lecture-item--reverse .lecture-bg {
  left: auto;
  right: -10px;
}
